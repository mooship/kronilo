...
export const NotFoundCard: FC = () => {
	...
	return (
		...
		>
			<h1 className="mb-2 font-bold text-3xl sm:text-5xl text-black dark:text-neutral-50">
				{t("notFound.title")}
			</h1>
			<p className="mb-8 text-black text-base sm:text-lg opacity-80 dark:text-neutral-50 dark:opacity-80">
				{t("notFound.message")}
			</p>
			<button
				type="button"
